...
public partial class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Maintenance>(entity =>
        {
            ...
            entity.Property(e => e.LineFaultDescription)
                .IsUnicode(false)
                .HasColumnName("lineFaultDescription");
        ...
        modelBuilder.Entity<Users>(entity =>
        {
            ...
            entity.HasKey(e => e.Id).HasName("PK__Users__3214EC07BB4F7FC0");

            entity.HasIndex(e => e.UserName, "UQ__Users__66DCF95C58AA2A4A").IsUnique();
            ...
            entity.HasOne(d => d.IdLineNavigation).WithMany(p => p.Users)
                .HasForeignKey(d => d.IdLine)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("FK__Users__idLine__71D1E811");
        });
